## Instruções docker:  
* docker build --tag cdc-admin .  
* docker run -p 3000:3000 --link cdc-api:cdc-api --name cdc-admin -d cdc-admin  
* docker run -p 3000:3000 --link cdc-api:cdc-api --name cdc-admin -d -v ~/caelum/repeteco/react/cdc-admin/build:/build cdc-admin
